...
var script = vue.defineComponent({
    ...
    props: {
        ...
        iconPack: {
            type: String,
            default: () => { return helpers.getValueByPath(config.getOptions(), 'checkbox.iconPack', undefined); }
        },
        /** Icon for checkbox (optional)  */
        iconCheck: {
            type: String,
            default: () => { return helpers.getValueByPath(config.getOptions(), 'checkbox.iconCheck', undefined); }
        },
