...
(function (global, factory) {
    ...
    function render$3(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.computedTag), vue.mergeProps(_ctx.$attrs, {
        ...
        /* PROPS */
        , ["pack", "icon", "size", "both", "class"]) : vue.createCommentVNode("v-if", true), _ctx.label ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$1, vue.toDisplayString(_ctx.label), 1
        /* TEXT */
        )) : _ctx.$slots.default ? (vue.openBlock(), vue.createBlock("span", _hoisted_2$1, [vue.renderSlot(_ctx.$slots, "default")])) : vue.createCommentVNode("v-if", true), _ctx.iconRight ? vue.createVNode(_component_o_icon, {
          key: 3,
          pack: _ctx.iconPack,
          icon: _ctx.iconRight,
          size: _ctx.size,
    ...
    function render$8(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createBlock("div", {
        ...
        key: 0
      }, [_ctx.placeholderVisible ? (vue.openBlock(), vue.createBlock("option", _hoisted_1$2, vue.toDisplayString(_ctx.placeholder), 1
      /* TEXT */
    ...
    function render$b(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createBlock("div", {
        ...
        default: vue.withCtx(() => [vue.createVNode(_component_o_dropdown_item, {
          ...
          }, [_ctx.$slots.header !== undefined && _ctx.$slots.header.length ? vue.renderSlot(_ctx.$slots, "header", {
            key: 0
          ...
          /* CLASS */
          ), vue.createVNode(_component_o_datepicker_table, {
          ...
          /* PROPS */
          , ["modelValue", "day-names", "month-names", "first-day-of-week", "rules-for-first-week", "min-date", "max-date", "focused", "disabled", "unselectable-dates", "unselectable-days-of-week", "selectable-dates", "events", "indicators", "date-creator", "type-month", "nearby-month-days", "nearby-selectable-month-days", "show-week-number", "week-number-clickable", "range", "multiple", "table-class", "table-head-class", "table-head-cell-class", "table-body-class", "table-row-class", "table-cell-class", "table-cell-selected-class", "table-cell-first-selected-class", "table-cell-invisible-class", "table-cell-within-selected-class", "table-cell-last-selected-class", "table-cell-first-hovered-class", "table-cell-within-hovered-class", "table-cell-last-hovered-class", "table-cell-today-class", "table-cell-selectable-class", "table-cell-unselectable-class", "table-cell-nearby-class", "table-cell-events-class", "table-events-class", "table-event-variant-class", "table-event-class", "table-event-indicators-class"]), _ctx.$slots.default !== undefined ? (vue.openBlock(), vue.createBlock("footer", {
            key: 0,
    ...
    const LoadingProgrammatic = {
        open(params) {
            ...
            const vnode = vue.createVNode(script$h, propsData);
    ...
    const ModalProgrammatic = {
        open(params) {
            ...
            return instance
            */
            const vnode = vue.createVNode(script$i, propsData);
            vnode.appContext = app._context;
            return vue.render(vnode, document.createElement('div'));
        }
    };
    ...
    const NotificationProgrammatic = {
        open(params) {
            ...
            const vnode = vue.createVNode(script$k, propsData, defaultSlot);
            vnode.appContext = app._context;
            return vue.render(vnode, document.createElement('div'));
        }
    };
    ...
    function render$k(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      /* PROPS */
      , ["linkClass", "linkCurrentClass", "page"])])) : vue.createCommentVNode("v-if", true), _ctx.hasFirstEllipsis ? (vue.openBlock(), vue.createBlock("li", _hoisted_2$2, [vue.createVNode("span", {
            ...
            newColumns() {
                if (this.columns && this.columns.length) {
                    return this.columns.map((column) => {
                        const vnode = vue.createVNode(script$y, column, (props) => {
    ...
    exports.Datetimepicker = index$5;
    exports.Dropdown = index$6;
    exports.Field = index$7;
    exports.Icon = index$8;
    exports.Input = index$9;
    exports.Inputitems = index$a;
    exports.Loading = index$b;
    ...
    exports.Sidebar = index$i;
    exports.Skeleton = index$h;
    exports.Slider = index$j;
    exports.Steps = index$k;
    exports.Switch = index$l;
    exports.Table = index$m;
    exports.Tabs = index$n;
    exports.Timepicker = index$o;
    exports.Tooltip = index$p;
    exports.Upload = index$q;
